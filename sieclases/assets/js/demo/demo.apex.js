...
var colorPalette = ['#8ac542', '#537df9', '#ffc200', '#ff5722', '#00bcd4']
...
var options2 = {
    ...
    colors: ["#537df9", "#8ac542", "#ff5722", "#00bcd4"],
    xaxis: {
        tickAmount: 12,
        type: 'datetime',
...
var options = {
    ...
    colors: ["#537df9", "#8897AA", "#8ac542", "#ff5722", "#e3eaef"],
    legend: {
        show: true,
        position: 'bottom',
...
var options = {
    ...
    labels: ["Series 1", "Series 2", "Series 3", "Series 4", "Series 5"],
    colors: ["#00bcd4", "#ffc200", "#313a46", "#ff5722", "#8ac542"],
    responsive: [{
        breakpoint: 600,
        options: {
            chart: {
...
var options = {
    ...
    fill: {
        ...
        gradient: {
            ...
            type: 'horizontal',
            shadeIntensity: 0.5,
            gradientToColors: ["#00bcd4", "#537df9"],
            inverseColors: true,
            opacityFrom: 1,
            opacityTo: 1,
            stops: [0, 100]
...
var options = {
    ...
    colors: ["#00bcd4", "#8ac542", "#e3eaef", "#8897AA", "#ffc200"],
    grid: {
        borderColor: '#f1f3fa',
        xaxis: {
            showLines: true
