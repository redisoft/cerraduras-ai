...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#537df9", "#8ac542", "#ff5722"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffc200", "#ff5722", "#537df9"]
        });
        ...
        Morris.Area({
            ...
            pointSize: 0,
            fillOpacity: 0.8,
            pointStrokeColors: ['#b4becb', '#00bcd4'],
            behaveLikeLine: true,
        ...
        Morris.Area({
            ...
            lineColors: ['#8ac542', '#ffc200', '#537df9'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffc200', '#ff5722', '#537df9'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffc200', '#ff5722', '#537df9'],
            lineWidth: 2,
            hideHover: true
        });
