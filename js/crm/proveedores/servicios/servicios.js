...
//===================================       SEGUIMIENTOS        ====================================//
//==================================================================================================//
function obtenerSeguimientoServicio(idCompra,idSeguimiento)
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'crm/obtenerSeguimientoServicioCompras',
		data:
		{
			"idServicio":	$('#txtIdServicioCrm').val(),
			"idProveedor":	$('#txtIdProveedorCrm').val(),
	...
	$(document).on("click", ".ajax-pagSeguimiento > li a", function(eve)
	{
		...
		$.ajax(
		{
			...
			data:
			{
				...
				inicio:			$('#txtInicioSeguimiento').val(),
				fin:			$('#txtFinSeguimiento').val(),
				idCompra:		$('#txtIdCompraSeguimiento').val()
			},
			dataType:"html",
...
function registrarSeguimientoServicios()
{
	...
	$.ajax(
	{
		...
		data:
		{
			...
			"idProveedor":		$('#txtIdProveedorSeguimiento').val(),
		...
		success:function(data, textStatus)
		{
			...
			switch(data[0])
			{
				...
				case "1":
					...
					obtenerSeguimientoServicio($('#txtIdCompraSeguimiento').val());
...
function formularioSeguimientoServicios()
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'crm/formularioSeguimientoServiciosCompras',
		data:
		{
			"idProveedor":	$('#txtIdProveedorSeguimiento').val(),
			"idServicio":	$('#txtIdServicioCrm').val(),
...
function obtenerSeguimientoEditar(idSeguimiento)
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'crm/obtenerSeguimientoEditarServicioCompras',
		data:
		{
