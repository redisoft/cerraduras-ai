$(document).ready(function()
{
	...
	$(document).on("click", ".ajax-pagReporte > li a", function(eve)
	{
		...
		$.ajax(
		{
			...
			data:
			{
			  	idCausa:			$('#selectCausasBusqueda').val(),
...
function obtenerReporte()
{
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'crm/obtenerReporteBajas',
		data:
		{
			idCausa:			$('#selectCausasBusqueda').val(),
			idPrograma: 		$('#selectProgramaBusqueda').val(),
...
function excelReporte()
{
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'crm/excelReporteBajas',
		data:
		{
			idCausa:			$('#selectCausasBusqueda').val(),
			idPrograma: 		$('#selectProgramaBusqueda').val(),
		...
		success:function(data, textStatus)
		{
			...
			window.location.href=base_url+'reportes/descargarExcelReportes/'+data+'/Bajas';
