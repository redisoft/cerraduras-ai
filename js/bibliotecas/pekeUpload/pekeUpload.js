...
(function($) 
{
  ...
  $.fn.pekeUpload = function(options)
  {
    ...
    function UploadFile(){
	  ...
	  formData.append('xml',$("#chkXml").is(':checked')?'1':'0');
	  formData.append('idUsuario',$("#selectPromotorPlantilla").val());
	  
	  formData.append('tipoPlantilla',$("#txtTipoPlantilla").val());
	  formData.append('idPrograma',$("#selectProgramaPlantilla").val());
      ...
      $.ajax({
			...
			{
				$('#importandoProspectosClientes').fadeIn();
			},
			//data: formData+'&moli=molita',
                    // dataType: 'json',
