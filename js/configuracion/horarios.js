...
function obtenerHorarios(idUsuario)
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'usuario/obtenerHorarios',
		data:
		{
			idUsuario:idUsuario
		},
...
function registrarHorario()
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'usuario/registrarHorario',
		...
		success:function(data, textStatus)
		{
			...
			switch(data[0])
			{
				...
				default:
					...
					obtenerHorarios($('#txtIdUsuario').val());
				break;
			}
		},
		error:function(datos)
...
function editarHorario(idHorario,i)
{
	...
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'usuario/editarHorario',
		data:
		{
			idHorario: idHorario,
...
function borrarHorario(idHorario)
{
	...
	$.ajax(
	{
		...
		beforeSend:function(objeto)
		{
			$('#confirmando').html('<label><img class="ajax-loader" src="'+base_url+'img/ajax-loader.gif"/>Borrando horario</label>');
		},
		type:"POST",
		url:base_url+'usuario/borrarHorario',
		data:
		{
			idHorario: idHorario,
		},
