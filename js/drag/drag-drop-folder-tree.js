		...
		*/
		...
		initTree : function()
		{
			...
			for(var no=0;no<menuItems.length;no++){
				...
				//aTag.id = 'nodeATag' + menuItems[no].id.replace(/[^0-9]/gi,''); //CAMBIE ESTA PARTE PARA MANEJARLO MEJOR
				aTag.id = 'subNivel' + menuItems[no].id.replace(/[^0-9]/gi,'');
