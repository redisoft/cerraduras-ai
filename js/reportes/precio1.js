...
function obtenerReporte()
{
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'reportes/obtenerPrecio1',
		data:
		{
			inicio: 	$('#FechaDia').val(),
			fin: 		$('#FechaDia2').val(),
...
function excelReporte()
{
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'reportes/excelPrecio1',
		data:
		{
			inicio: 	$('#FechaDia').val(),
			fin: 		$('#FechaDia2').val(),
		...
		success:function(data, textStatus)
		{
			...
			window.location.href=base_url+'reportes/descargarExcelReportes/'+data+'/reportePrecio1'
...
function pdfReporte()
{
	$.ajax(
	{
		...
		type:"POST",
		url:base_url+'reportes/reportePrecio1',
		data:
		{
			inicio: 	$('#FechaDia').val(),
			fin: 		$('#FechaDia2').val(),
		...
		success:function(data, textStatus)
		{
			...
			window.location.href = base_url + 'reportes/descargarPdfReportes/' + data +'/reportePrecio1'
			//$("#cargarProductos").html(data);
		},
		error:function(datos)
		{
