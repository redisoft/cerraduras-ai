function borrarDocumentoTemporal(idDocumento,temporal)
{
	...
	$.ajax(
	{
		...
		{
			$('#agregandoPersonal').html('<label><img class="ajax-loader" src="'+base_url+'img/ajax-loader.gif"/>Borrando el documento</label>');
		},
		type:"POST",
		url:base_url+'administracion/borrarDocumentoTemporal/'+temporal,
		data:
		{
