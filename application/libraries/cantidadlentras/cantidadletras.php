...
private $textos_ingles=array(
0=> array('A ', 'DOS ', 'THREE ','FOUR ','FIVE ','SIX ','SEVEN ','EIGHT ','NINE ','A '),
1=> array('ONCE ','TWELVE ','THIRTEEN ','FOURTEEN ','FIFTEEN ','SIXTEEN ','SEVENTEEN ','EIGHTEEN ','NINETEEN ',''),
2=> array('TEN ', 'TWENTY ','THIRTY ','FORTY ','FIFTY ','SIXTY ', 'SEVENTY ','EIGHTY ','NINETY ','TWENTY '),
3=> array('HUNDRED ','TWO HUNDRED ','THREE HUNDRED ', 'FOUR HUNDRED', 'FIVE HUNDRED ', 'SIX HUNDRED ','SEVEN HUNDRED ','EIGHT HUNDRED ','NINE HUNDRED ','ONE HUNDRED '),
4=> array('HUNDRED ','TWO HUNDRED ','THEREE HUNDRED ','FOUR HUNDRED ', 'FIVE HUNDRED ', 'SIX HUNDRED ', 'SEVEN HUNDRED ', 'EIGHT HUNDRED ','NINE HUNDRED ','ONE HUNDRED '),
5=> array('THOUSAND ', 'MILLION ', 'MILLION ','ZERO ','AND ', 'ONE ','TWO ', 'WITH ','','')
);
	private $aTexto;
         ...
         switch($Idioma){
                ...
                case "ES":
                 ...
                 case "IN":
		            for($i=0; $i<6;$i++)
                 	      for($j=0;$j<10;$j++)
				$this->aTexto[$i][$j]=$this->textos_ingles[$i][$j];
                            break;
             }
