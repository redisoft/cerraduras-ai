...
class Googlemaps {
	...
	var $posicionX					= "0px";					// POSICION X
	var $posicionY					= "0px";					// POSICION Y
	var $posicion					= "relative";				// POSICION Y
	...
	function create_map()
	{
		...
		#$this->output_html .= '<div id="'.$this->map_div_id.'" style="margin-top:23%; margin-left:47%; position:absolute; width:'.$this->map_width.'; height:'.$this->map_height.';"></div>';
		$this->output_html .= '<div id="'.$this->map_div_id.'" style="margin-top:'.$this->posicionY.'; margin-left:'.$this->posicionX.'; position:'.$this->posicion.'; width:'.$this->map_width.'; height:'.$this->map_height.';"></div>';
