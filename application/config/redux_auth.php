...
$config['auth']['salt']	= 'SADYET74747YEYEYTRY747Y464';
...
$config['auth']['proveedores_table']	= 'proveedores';
$config['auth']['usuarios_table'] 	= 'usuarios';
$config['auth']['sessions_table']	= 'sessions';
