...
function procesarXmlArreglo($xml)
{
	...
	{ 
		...
		$cfdi[14]	= strlen($cfdiComprobante['Moneda'])>0?($cfdiComprobante['Moneda']):'MXN';
	...
	{ 
	   ...
	   $cfdi[20]	= $DomicilioFiscal['municipio'];
	...
	{ 
	   ...
	   $cfdi[32]	= $ReceptorDomicilio['noInterior'];
	...
	{
	    $cfdi[38]	= (string)$tfd['RfcProvCertif'];
		$cfdi[39]	= (string)$tfd['FechaTimbrado'];
		$cfdi[40]	= (string)$tfd['UUID'];
		$cfdi[41]	= (string)$tfd['NoCertificadoSAT'];
		$cfdi[42]	= (string)$tfd['Version'];
		$cfdi[43]	= (string)$tfd['SelloSAT'];
