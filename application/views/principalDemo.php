...
<li '.$permiso.' id="" ><div class="letras">Administración</div>
	...
	#VEHÍCULOS
	#------------------------------------------------------------------------------------------------------------#
	$permiso=' onclick="window.location.href=\''.base_url().'administracion/vehiculos\'"';
	...
	echo'<li  '.$permiso.' id="menu-vehiculos" ><div class="letras">Vehículos</div></li>';
...
echo'
<div class="col-md-2 margenResponsivoIzquierdo"><li '.$permiso.'><div class="letras">Reportes</div> </li></div>';
