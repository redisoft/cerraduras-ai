...
$excel->getActiveSheet()->setCellValue('N'.$i, 'Precio');
...
foreach($productos as $row)
{
	...
	$excel->getActiveSheet()->setCellValue('N'.$i, $row->precioImpuestos);
	...
	$excel->getActiveSheet()->getStyle('N'.$i.':O'.$i)->getNumberFormat()->setFormatCode('$0.00');
