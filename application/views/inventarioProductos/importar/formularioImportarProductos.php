...
<script type="text/javascript">
	...
	{ 
		$("#txtImportarFichero").pekeUpload(
		{
			...
			url:				base_url+'importar/subirArchivoProductos',
			maxSize:			25,
			...
			onFileSuccess:function(file,data)
			{
				...
				switch(data)
				{
					...
					case "1":
						$('#ventanaImportarProductos').dialog('close');
						obtenerProductos();
...
<table class="admintable" width="100%">
    <tr>
        <td colspan="2" align="center">
            Favor de descargar el formato para que los productos se importen correctamente.<br />
            <a href="'.base_url().'importar/descargarFormato/productos">Formato productos.xls</a>
        </td>
    </tr>
