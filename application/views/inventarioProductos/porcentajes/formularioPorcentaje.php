...
<form id="frmAsignarPorcentajes">
	<table class="admintable" style="width:100%">
		<tr>
			...
			<td>
				'.$producto->nombre.'
				<input type="hidden" class="cajas" id="txtIdProducto" name="txtIdProducto" value="'.$producto->idProducto.'">
				
				<input type="hidden" class="cajas" id="txtPrecioA" name="txtPrecioA" value="'.$producto->precioA.'">
				<input type="hidden" class="cajas" id="txtPrecioB" name="txtPrecioB" value="'.$producto->precioB.'">
				<input type="hidden" class="cajas" id="txtPrecioC" name="txtPrecioC" value="'.$producto->precioC.'">
