...
<form id="frmEditarProducto" name="frmEditarProducto">
	...
	<table class="admintable" width="100%">
			...
			<td>';
				...
				echo"<input type='text' class='cajas' style='width:98%' id='txtNombre' name='txtNombre' value='' />";
	...
	<table class="admintable" style="width:100%" id="tablaSucursales">
		<tr>
			...
			<input type="checkbox" id="chkSucursales" name="chkSucursales" onchange="checarRegistrosGenerico('.count($licencias).',\'chkSucursales\',\'chkSucursal\')"  style="height: 25px; width: 25px;"/>
			</th>
		</tr>';
		$i=0;
		foreach($licencias as $row)
		{
			...
			<tr>
				...
				<td>'.$row->nombre.'</td>
				<td width="15%" align="center"><input type="checkbox" id="chkSucursal'.$i.'" name="chkSucursal'.$i.'" value="'.$row->idLicencia.'" '.($row->idLicencia==1?'checked="checked"':'').' style="height: 25px; width: 25px;"/></td>
			</tr>';
