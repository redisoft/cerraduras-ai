...
$(document).ready(function()
{
	...
	{
		source:"'.base_url().'configuracion/obtenerProductosInventarioRepetido/nombre",
	...
	$("#txtCodigoInterno").autocomplete(
	{
		source:"'.base_url().'configuracion/obtenerProductosInventarioRepetido/codigoInterno",
		
		select:function( event, ui)
		{
			notify("El producto ya esta registrado",500,5000,"error",5,5);
			document.getElementById("txtCodigoInterno").reset();
		}
	});
...
<input type="hidden" id="txtIdPedimentoRegistro" name="txtIdPedimentoRegistro" value="0" />
<table class="admintable" width="100%;">
	...
	<tr>
		<td class="key">Solo en tienda:</td>
		<td>
			&nbsp;<input type="checkbox" name="chkSolo" id="chkSolo" value="1" style="width: 20px; height: 20px" /> 
		</td>
	</tr>
	...
	<tr>
		...
		<td >
			<span id="lblPedimento">Seleccione</span>
			&nbsp;&nbsp;  <img id="btnBorrarPedimento" style="display: none" src="'.base_url().'img/borrar.png" width="18" title="Borrar pedimento" onclick="borrarPedimentoProducto()" />
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			A partir de: <input type="text" class="cajas" name="txtApartirB" id="txtApartirB" style="width:60px" value="" onkeypress="return soloDecimales(event)" maxlength="7"/>
	...
	<tr>
		...
		<td>
			<input type="text" class="cajas" name="txtStockMinimo" id="txtStockMinimo" style="width:20%" onkeypress="return soloDecimales(event)" maxlength="15"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" class="cajas" name="txtStockMaximo" id="txtStockMaximo" style="width:20%" onkeypress="return soloDecimales(event)" maxlength="15"/>
		</td>
	</tr>
