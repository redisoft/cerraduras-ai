...
<form id="frmRegistroProspectoSie">
    <table class="admintable" width="100%">
        ...
        <tr>
            ...
            <td>
               De <input type="text" 	class="cajas" 	id="txtFechaInicialSie" 	name="txtFechaInicialSie" 	style="width:100px"  readonly="readonly"/>
               a <input type="text" 	class="cajas" 	id="txtFechaFinalSie"	 	name="txtFechaFinalSie" 	style="width:100px"  readonly="readonly"/>
               
               <!--value="<?=$semana->diaInicio?>"
               value="<?=$semana->diaFin?>"-->
            </td>
        </tr>
         ...
         <tr>
            ...
            <td>
                <input type="text" class="cajas" id="txtMetaSie" name="txtMetaSie" style="width:100px" onkeypress="return soloNumerico(event)" maxlength="5"  />
            </td>
        </tr>
    </table>
</form>