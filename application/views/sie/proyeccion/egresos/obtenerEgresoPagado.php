...
<form id="frmRegistro">
    ...
    <input type="hidden" id="txtImporteEgreso" name="txtImporteEgreso" value="<?=$registro->importe?>"  />
    
    <input type="hidden" id="txtNumeroCuentas" name="txtNumeroCuentas" value="<?=count($cuentas)?>"  />
    <input type="hidden" id="txtTotalPagadoEgreso" name="txtTotalPagadoEgreso" value="0"  />
