...
$excel->getActiveSheet()->getStyle('A'.$i.':N'.$i)->getFont()->setSize(11);
...
$excel->getActiveSheet()->setCellValue('J'.$i, obtenerNombrePrecio(2));
$excel->getActiveSheet()->setCellValue('K'.$i, obtenerNombrePrecio(3));
$excel->getActiveSheet()->setCellValue('L'.$i, obtenerNombrePrecio(4));
$excel->getActiveSheet()->setCellValue('M'.$i, obtenerNombrePrecio(5));
$excel->getActiveSheet()->setCellValue('N'.$i, 'Costo');
...
foreach($productos as $row)
{
	...
	$excel->getActiveSheet()->setCellValue('K'.$i, $row->precioC);
	$excel->getActiveSheet()->setCellValue('L'.$i, $row->precioD);
	$excel->getActiveSheet()->setCellValue('M'.$i, $row->precioE);
	$excel->getActiveSheet()->setCellValue('N'.$i, $row->costo);

	$excel->getActiveSheet()->getStyle('H'.$i)->getNumberFormat()->setFormatCode('0.00');
	$excel->getActiveSheet()->getStyle('I'.$i.':N'.$i)->getNumberFormat()->setFormatCode('$0.00');
