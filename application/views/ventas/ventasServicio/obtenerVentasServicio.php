...
{*/
	...
	<div style="width:100%; margin-bottom:1%;">
		<ul id="pagination-digg" class="ajax-pagVentasServicio">'.$this->pagination->create_links().'</ul>
	</div>';
	?>
    
    <ul class="menuTabs" >
        <li style="margin-top:0px" onclick="window.location.href='<?php echo base_url()?>ventas'">Ventas</li>
        <li style="margin-top:0px" onclick="window.location.href='<?php echo base_url()?>ventas/ventasProducto'">Ventas por producto</li>
        <li style="margin-top:0px" class="activado">Ventas por servicio</li>
    </ul>
	...
	<table class="admintable" width="100%" >
		...
		<tr>
        	<th class="encabezadoPrincipal" colspan="9">
                ...
                <img src="'.base_url().'img/pdf.png" width="22" onclick="reporteVentasServicio()" title="PDF" />
				<img src="'.base_url().'img/excel.png" width="22" onclick="excelVentasServicio()" title="Excel" />
            </th>
        </tr>';
		?>
	 	...
	 	<tr>
            ...
            <th align="center">
                ...
                <select class="cajas" id="selectClientesBusqueda" style="width:120px" onchange="obtenerVentasServicio()">
			...
			<th align="center">
            	<?php
				echo '
				<select class="cajas" id="selectVentasBusqueda" style="width:80px" onchange="obtenerVentasServicio()">
            ...
            <th align="center" >
            	<?php
				echo '
				<select class="cajas" id="selectProductosBusqueda" style="width:100px" onchange="obtenerVentasServicio()">
