...
<form id="frmHorario" name="frmHorario">
	<table width="100%" class="admintable" id="tablaHorarios">
		<tr>
			<th colspan="2" class="encabezadoPrincipal">Detalles de personal</th>
		</tr>
	...
	echo '
	<table width="100%" class="admintable" id="tablaHorarios2">
		<tr>
			<th colspan="11" class="encabezadoPrincipal">Registro</th>
		</tr>
		...
		<tr>
			...
			<th class="datos">Hora entrada</th>
			<th class="datos">Hora salida</th>
		</tr>
		<tr>
			...
			<td align="center"><input type="text" class="cajas" style="width:50px" id="txtHoraInicial" name="txtHoraInicial" value="'.date('H:00').'" readonly="readonly" /></td>
			<td align="center"><input type="text" class="cajas" style="width:50px" id="txtHoraFinal" name="txtHoraFinal" value="'.date('H:00').'" readonly="readonly" /></td>
		</tr>
	</table>
</form>';
if($horarios!=null)
{
	...
	$(document).ready(function()
	{
		$("#tablaHorarios tr:even").addClass("sinSombra");
		$("#tablaHorarios tr:odd").addClass("sombreado");  
	});
	</script>

	<table width="100%" class="admintable" id="tablaHorarios">
		<tr>
			<th colspan="11" class="encabezadoPrincipal">Lista de horarios</th>
		</tr>
