...
$(document).ready(function()
{
	...
	$("#txtFechaNacimiento,#txtFechaNacimientoPadre,#txtFechaNacimientoMadr").datepicker({changeYear: true});';
...
<ul class="menuTabsCliente">
	...
	if($tipoRegistro=='clientes')
	{
		...
		<li id="cuentasBanco" class="cliente" onclick="configurarTabsCliente(\'cuentasBanco\')">Cuentas banco</li>
		'.(sistemaActivo=='olyess'?'<li id="direccionesEntrega" class="cliente" onclick="configurarTabsCliente(\'direccionesEntrega\')">Direcciones entrega</li>':'').'
		'.(sistemaActivo=='IEXE'?'<li id="academicos" class="cliente" onclick="configurarTabsCliente(\'academicos\')">Académicos</li>':'').'
		'.(sistemaActivo=='IEXE'?'<li id="documentos" class="cliente" onclick="configurarTabsCliente(\'documentos\')">Documentos</li>':'');
	}
		...
		<table class="admintable" width="100%;">
			<tr>
			 ...
			 <tr>
				...
				<td>
					<input type="text" class="cajas" name="txtNombrePadre" id="txtNombrePadre" style="width:200px" placeholder="Nombre" value="'.($padre!=null?$padre->nombrePadre:'').'"/>
					<input type="text" class="cajas" name="txtApellidoPaternoPadre" id="txtApellidoPaternoPadre" style="width:200px" placeholder="Apellido paterno" value="'.($padre!=null?$padre->apellidoPaternoPadre:'').'"/>
					<input type="text" class="cajas" name="txtApellidoMaternoPadre" id="txtApellidoMaternoPadre" style="width:200px" placeholder="Apellido materno" value="'.($padre!=null?$padre->apellidoMaternoPadre:'').'"/>
					
					<input type="hidden" name="txtIdPadre" 				id="txtIdPadre" 			value="'.($padre!=null?$padre->idPadre:'0').'"/>
					<input type="hidden" name="txtPadreRelacionado"	 	id="txtPadreRelacionado" 	value="'.($padre!=null?'1':'0').'"/>
				</td>
			</tr>
			<tr>
				<td class="key">Cumpleaños:</td>
				<td>
					<input placeholder="Fecha" type="text" class="cajas" name="txtFechaNacimientoPadre" id="txtFechaNacimientoPadre" style="width:100px" value="'.($padre!=null?$padre->fechaNacimientoPadre:'').'"/>
				</td>
			</tr>
			<tr>
				<td class="key">Teléfono:</td>
				<td>
					<input type="text" class="cajas" name="txtTelefonoPadre" id="txtTelefonoPadre" style="width:200px" value="'.($padre!=null?$padre->telefonoPadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" class="cajas" name="txtCelularPadre" id="txtCelularPadre" style="width:200px" value="'.($padre!=null?$padre->celularPadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" class="cajas" name="txtEmailPadre" id="txtEmailPadre" style="width:200px" value="'.($padre!=null?$padre->emailPadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" class="cajas" name="txtOcupacionPadre" id="txtOcupacionPadre" style="width:200px" value="'.($padre!=null?$padre->ocupacionPadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" class="cajas" name="txtNombreMadre" id="txtNombreMadre" style="width:200px" placeholder="Nombre" value="'.($padre!=null?$padre->nombreMadre:'').'"/>
					<input type="text" class="cajas" name="txtApellidoPaternoMadre" id="txtApellidoPaternoMadre" style="width:200px" placeholder="Apellido paterno" value="'.($padre!=null?$padre->apellidoPaternoMadre:'').'"/>
					<input type="text" class="cajas" name="txtApellidoMaternoMadre" id="txtApellidoMaternoMadre" style="width:200px" placeholder="Apellido materno" value="'.($padre!=null?$padre->apellidoMaternoMadre:'').'"/>
				</td>
			</tr>
			<tr>
				<td class="key">Cumpleaños:</td>
				<td>
					<input placeholder="Fecha" type="text" class="cajas" name="txtFechaNacimientoMadre" id="txtFechaNacimientoMadre" style="width:100px" value="'.($padre!=null?$padre->fechaNacimientoMadre:'').'"/>
				</td>
			</tr>
			<tr>
				<td class="key">Teléfono:</td>
				<td>
					<input type="text" class="cajas" name="txtTelefonoMadre" id="txtTelefonoMadre" style="width:200px" value="'.($padre!=null?$padre->telefonoMadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				<td class="key">Móbil:</td>
				<td>
					<input type="text" class="cajas" name="txtCelularMadre" id="txtCelularMadre" style="width:200px" value="'.($padre!=null?$padre->celularMadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				<td class="key">Email:</td>
				<td>
					<input type="text" class="cajas" name="txtEmailMadre" id="txtEmailMadre" style="width:200px" value="'.($padre!=null?$padre->emailMadre:'').'"/>
				</td>
			</tr>
			...
			<tr>
				<td class="key">Ocupación:</td>
				<td>
					<input type="text" class="cajas" name="txtOcupacionMadre" id="txtOcupacionMadre" style="width:200px" value="'.($padre!=null?$padre->ocupacionMadre:'').'"/>
				</td>
			</tr>
		</table>
	</div>
		...
		<table class="admintable" width="100%;">
			...
			<tr '.($tipoRegistro=='prospectos'?'style="display:none"':'').'>
				...
				<td>
					<select class="cajas" id="selectTipoProspecto" name="selectTipoProspecto" style="width:120px">';
						echo '<option  value="0">'.(sistemaActivo=='IEXE'?'Alumno':'Cliente').'</option>';
						$seleccionado=$cliente->prospecto==1?'selected="selected"':'';
						echo '<option '.$seleccionado.' value="1">Prospecto</option>';
						
						 if(sistemaActivo=='IEXE')
						 {
							 $seleccionado=$cliente->prospecto==2?'selected="selected"':'';
							echo '<option '.$seleccionado.' value="2">Cliente</option>';
						 }

						/*
						
						$seleccionado=$cliente->prospecto==2?'selected="selected"':'';
						echo '<option '.$seleccionado.' value="2">Baja</option>';*/
				...
				if(sistemaActivo=='IEXE')
				{
					...
					<tr '.($tipoRegistro=='prospectos'?'style="display:none"':'').'>
						...
						<td>
							<select class="cajas" id="selectTipoCliente" name="selectTipoCliente" style="width:120px">
								...
								<option '.($cliente->idTipo==2?'selected="selected"':'').' value="2">VIP</option>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<!--<input type="text" class="cajas" id="txtPromotor" name="txtPromotor" style="width:200px" value="'.$cliente->promotor.'" />-->
							
							<select class="cajas" id="selectPromotores" name="selectPromotores" style="width:200px">';
							
							foreach($promotores as $row)
							{
								echo '<option '.($row->idUsuario==$cliente->idPromotor?'selected="selected"':'').' value="'.$row->idUsuario.'">'.$row->nombre.'</option>';
							}
					...
					<tr >
						...
						<td>
							<input type="hidden" id="txtIdCampanaOriginal"  name="txtIdCampanaOriginal"  value="'.$cliente->idCampanaOriginal.'" />
							
							<select class="cajas" id="selectCampana" name="selectCampana" style="width:500px" onchange="obtenerProgramasCampanaRegistro()">
					...
					if($tipoRegistro=='prospectos')
					 {
						 ...
						 <input type="hidden" id="txtTipoRegistroClientes" name="txtTipoRegistroClientes" value="prospectos">
						 
						 <tr>
							<td class="key">Programa:</td>
							<td>
								<div id="obtenerProgramasRegistro" style="width:500px; float: left">
									<select class="cajas" id="selectProgramasProspecto" name="selectProgramasProspecto" style="width:500px" >
										<option value="0">Seleccione</option>';
					...
					<tr>
						...
						<td>
							<input type="text" class="cajas" id="txtNombreAlumno"		name="txtNombreAlumno" style="width:200px" placeholder="Nombre" value="'.$cliente->nombre.'"/>
							<input type="text" class="cajas" id="txtApellidoPaterno" 	name="txtApellidoPaterno" style="width:200px" placeholder="Apellido paterno" value="'.$cliente->paterno.'"/>
							<input type="text" class="cajas" id="txtApellidoMaterno" 	name="txtApellidoMaterno" style="width:200px" placeholder="Apellido materno" value="'.$cliente->materno.'" />
						</td>
					</tr>';
				}
			...
			if(sistemaActivo=='IEXE')
			{
				...
				<tr>
					...
					<td>
						<input type="text" class="cajas" id="txtFechaNacimiento" name="txtFechaNacimiento" style="width:100px" value="'.$cliente->fechaNacimiento.'" />
					</td>
				</tr>';
			}
			...
			<tr>
			 ...
			 <tr>
				<td class="key">Email:</td>
				<td>
					<input type="text" class="cajas"  value="'.$cliente->email.'" name="email" id="email" style="width:200px" placeholder="Email 1"/><br />
					<input type="text" class="cajas"  value="'.$cliente->email2.'" name="email2" id="email2" style="width:200px" placeholder="Email 2"/><br />
					<input type="text" class="cajas"  value="'.$cliente->email3.'" name="email3" id="email3" style="width:200px" placeholder="Email 3"/><br />
					<input type="text" class="cajas"  value="'.$cliente->email4.'" name="email4" id="email4" style="width:200px" placeholder="Email 4"/><br />
					<input type="text" class="cajas"  value="'.$cliente->email5.'" name="email5" id="email5" style="width:200px" placeholder="Email 5"/>
				</td>
			</tr>
			...
			<tbody '.($tipoRegistro=='prospectos'?'style="display:none"':'').'>
			<tr>
		   ...
		   <tr>
			...
			<tbody '.(sistemaActivo=='olyess'?'style="display: none"':'').'>
				<tr>
				  ...
				  <tr>
					...
					<td>
						...
						<textarea class="TextArea" name="direccionEnvio" id="direccionEnvio" style="width:205px">'.$cliente->direccionEnvio.'</textarea>
					</td>
				</tr>
				 ...
				 <tr>
					...
					<td>
						<input type="text" class="cajas"  value="'.$cliente->codigoPostalEnvio.'" name="codigoPostalEnvio" id="codigoPostalEnvio" style="width:200px"/>
					</td>
				</tr>
				 ...
				 <tr>
					...
					<td>
						<input type="text" class="cajas"  value="'.$cliente->estadoEnvio.'" name="estadoEnvio" id="estadoEnvio" style="width:200px"/>
					</td>
				</tr>
				 <tr>
					<td class="key">Ciudad</td>
					<td>
						<input type="text" class="cajas"  value="'.$cliente->localidadEnvio.'" name="ciudadEnvio" id="ciudadEnvio" style="width:200px"/>
					</td>
				</tr>
			</tbody>
		</table>
