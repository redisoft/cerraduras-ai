		...
		<table class="admintable" width="100%;">
			...
			<tr>
				...
				<td>';
					...
					echo"<input type='text' class='cajas' id='empresa' name='empresa' style='width:650px' value='".$cliente->empresa."' />";
					
					echo'<input type="hidden" id="txtClienteId"  name="txtClienteId"  value="'.$cliente->idCliente.'" />
				</td>
				</tr>
			<tr>
