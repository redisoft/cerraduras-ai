...
<head>
	...
	if($jquery=='1')
	{
		...
		<script src="'.base_url().'js/bibliotecas/barcode.js"></script>
		<!--<script src="'.base_url().'js/bibliotecas/jquery-barcode.js"></script>-->
		
		<script>
			$(document).ready(function()
			{
				$("#codigoTicket").barcode("'.$venta->folio.'", "code128",{barWidth:5, barHeight:80})
