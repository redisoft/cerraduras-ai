...
<script type="text/javascript">
	...
	{ 
		$("#txtImportarFichero").pekeUpload(
		{
			...
			url:				base_url+'importar/subirArchivoClientes',
			maxSize:			25,
...
<table class="admintable" width="100%">
    <tr>
        <td colspan="2" align="center">
            Favor de descargar el formato para que los clientes se importen correctamente.<br />
            <a href="'.base_url().'importar/descargarFormato/clientes">Formato clientes.xls</a>
        </td>
    </tr>
