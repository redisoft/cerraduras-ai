...
echo'
<input type="hidden" id="txtIdClienteSeguimiento" 		value="'.($idCliente>0?$idCliente:$seguimiento->idCliente).'" />
<input type="hidden" id="txtIdCotizacionSeguimiento" 	value="'.($idServicio==1?$idCotizacion:0).'" />
<input type="hidden" id="txtIdVentaSeguimiento" 		value="'.($idServicio==2?$idCotizacion:0).'" />
<input type="hidden" id="txtRegistrarCrm" name="txtRegistrarCrm"  value="'.$permiso[1]->activo.'"/>
...
<table class="admintable" width="100%;" >
	...
	<tr>
		<td class="key">'.($idServicio==1?'Cotización':'Venta').': </td>
		<td>'.($idServicio==1?$seguimiento->serie:$seguimiento->ordenCompra).'</td>
	</tr>
</table>';
