...
<table class="admintable" width="100%">
	<tr>
		...
		<td>
			<input name="txtAsuntoFichaCliente" style="width:300px" id="txtAsuntoFichaCliente" type="text" class="cajas" value="Ficha tecnica cliente: '.$cliente->empresa.'" />
		</td>
	</tr>';
	...
	<tr>
		...
		<td>
			<textarea name="txtCorreoFichaCliente" id="txtCorreoFichaCliente" rows="3" class="TextArea" style="width:300px">'.$cliente->email.'</textarea>
		</td>
	</tr>	
	<tr>
