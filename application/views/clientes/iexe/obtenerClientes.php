	...
	<table class="admintable" width="100%">
		...
		<tr>
			<td colspan="12" class="sinbordeTransparente">
				<ul class="menuTabs">
					...
					<li class="activado" style="margin-top:10px; width: 150px" onclick="window.location.href=\''.base_url().'clientes\'">Universo</li> 
		...
		<tr>
            ...
            <th class="encabezadoPrincipal" >
            	...
            	<select id="selectZonasBuscar" name="selectZonasBuscar" class="cajas" style="width:100px" onchange="obtenerClientes()">
