...
<script src="<?php echo base_url()?>js/clientes/activos.js"></script>
   ...
   <tr>
		<?php
			...
			<td class="button" width="5%">
				<a id="bntRegistrarCliente" onclick="formularioClientes(\'recargar\')">
					<img src="'.base_url().'img/clientes.png" width="30px;" height="30px;" title="Añadir nuevo prospecto" alt="Añadir nuevo cliente" /><br />
			   		Agregar nuevo <br /> Prospecto/'.(sistemaActivo=='IEXE'?'Alumno':'Cliente').'     
				</a>      
			</td>
			...
			{ 
				echo '
				<script>
					desactivarBotonSistema(\'btnPeriodos\');
				</script>';
			}
        ...
        ?>
         <td width="80%" align="left" valign="middle" >
			<input type="text"  name="txtBusquedas" id="txtBusquedas" class="busquedas" placeholder="<?php echo sistemaActivo=='IEXE'?'Buscar por alumno/cliente, teléfono, email, matrícula':'Buscar por cliente, teléfono, email'?>" style="width:600px" />
         </td>  
         </tr>
...
<div class="listproyectos">
    ...
    <div id="obtenerClientes">
        ...
        <input type="hidden" name="selectZonasBuscar" 			id="selectZonasBuscar" value="1" /> 
...
if(sistemaActivo=='IEXE')
{
	$this->load->view('configuracion/periodos/catalogo');	
}
