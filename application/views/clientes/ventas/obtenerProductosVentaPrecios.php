	...
	foreach($productos as $row)
	{
		...
		<div class="puntoVenta" title="Agregar '.$row->nombre.'" >';
			...
			'<section class="precio" >
				<select id="selectPrecios'.$i.'" class="cajasPrecios" style="height: 23px; width:80px" >
			...
			<section '.$onclick.'>'.$row->nombre.(strlen($row->codigoInterno)>0?'<br />Código: '.$row->codigoInterno:'').'</section>';
