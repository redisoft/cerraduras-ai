...
if($productos!=null)
{
	...
	<table class="admintable" width="100%">
		<tr>
			...
			<th>Unidad</th>
			<th>Stock</th>
			<th style="display:none">'.obtenerNombrePrecio(2).'</th>
	...
	foreach($productos as $row)
	{
		...
		echo'		
		<tr '.$onclick.' '.($i%2>0?'class="sinSombra"':'class="sombreado"').'>
			<td >';
