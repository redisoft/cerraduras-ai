<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/departamentos.js"></script>
<div class="derecha">
<div class="submenu">
 ...
 <table class="toolbar" width="10%">
    <tr>
      <td style="border:none" align="center" valign="middle" class="button">
        <a id="btnAgregarDepartamento" onclick="formularioDepartamentos()" title="Agregar departamento" >
       ...
       <?php
		if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnAgregarDepartamento\');
			</script>';
		}
       ?>
       </td>
...
<div id="procesandoDepartamentos"></div>
<div id="obtenerDepartamentos"></div>


    <div id="ventanaDepartamentos" title="Registrar departamento">
