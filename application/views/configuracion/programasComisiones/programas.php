<script src="<?php echo base_url()?>js/configuracion/programas/programasComisiones.js"></script>
<script>
...
<div class="toolbar" id="toolbar">
   <table class="toolbar" width="100%">
        <tr>
			...
			{
				?>
                <td width="5%" align="center" valign="middle"><a href="<?php print(base_url()."configuracion/programasComisiones"); ?>" class="escalaGrisesConfiguracion"  ><span class="icon-option" title="Comisiones"><img src="<?php print(base_url()); ?>img/comisiones.png"  style="max-width: 30px; max-height: 30px" title="Comisiones"  /></span>Comisiones</a></td>
                <?php
			}
			?>
...
<div class="listproyectos" >
    ...
    <table class="toolbar" width="100%">
        <tr>
            <td style="border:none" width="1%" align="center" valign="middle" class="button">
