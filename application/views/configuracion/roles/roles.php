<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/roles.js"></script>
<div class="derecha">
<div class="submenu">
	...
	<!--<div class="seccionDiv">
      ...
      <table class="toolbar" width="100%">
        <tr>
			...
			?>
            <td width="5%" align="center" valign="middle"><a href="<?php print(base_url()."configuracion/roles"); ?>" class="escalaGrisesConfiguracion" > <span class="icon-option" title="Añadir nuevo usuario"> <img src="<?php print(base_url()); ?>img/roles.png"   width="30" height="30" title="Roles" /></span> Roles </a> </td>
 ...
 <table class="toolbar" width="10%">
    <tr>
      <td style="border:none" align="center" valign="middle" class="button">
        ...
        <a id="btnRegistrarRol" onclick="formularioRoles()" title="Agregar rol" style="cursor:pointer">
            <img src="<?php echo base_url() ?>img/add.png" title="Añadir Rol" /> <br />
			Añadir Rol
        </a>
		...
		if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnRegistrarRol\');
			</script>';
		}
       ?>
       </td>
...
if(!empty ($roles))
{
	...
	<table width="100%;" class="admintable" >
        <thead>
            <tr>
                ...
                <th class="encabezadoPrincipal" width="60%" align="center">Rol</th>
	...
	?>
		...
		<td align="center" valign="middle"><?php print($row->nombre); ?></td>
		<td align="center" valign="middle">
		 	<?php
		 	echo '
			<img id="btnEditarRol'.$i.'" style="cursor:pointer" src="'.base_url().'img/editar.png" width="22" height="22" title="Editar rol" onclick="accesoEditarRol('.$row->idRol.')">
			<img id="btnBorrarRol'.$i.'" onclick="borrarRolUsuario('.$row->idRol.',\'¿Realmente desea quitar este rol?\')"  src="'.base_url().'img/quitar.png" width="22" />
			
			<br />
			<a id="a-btnEditarRol'.$i.'">Editar</a> 
			<a id="a-btnBorrarRol'.$i.'">Borrar</a>';
			
			if($permiso[2]->activo==0 or $row->sistema=='1')
			{
				 echo '
				<script>
					desactivarBotonSistema(\'btnEditarRol'.$i.'\');
				</script>';
			}
			...
			if($permiso[3]->activo==0 or $row->sistema=='1')
			{
				 echo '
				<script>
					desactivarBotonSistema(\'btnBorrarRol'.$i.'\');
				</script>';
			}
		?>
		 </td>
...
else
{
	...
	<div class="Error_validar" style="margin-top:2px; width:90%; margin-bottom: 5px;">
		Sin registros de roles
    </div>';
}
?>
<div id="ventanaAgregarRoles" title="Registrar Rol">
    <div id="registrandoRol"></div>
    <div class="ui-state-error" ></div>
    <div id="formularioRoles"></div>
</div>
	
<div id="ventanaEditarRoles" title="Editar rol">
<div id="editandoRol"></div>
<div class="ui-state-error" ></div>
<div id="obtenerRol"></div>
</div>
