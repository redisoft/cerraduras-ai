<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/divisas.js"></script>
...
<div class="toolbar" id="toolbar">
    ...
    <table class="toolbar" width="100%">
        <tr>
			...
			<td width="5%" align="center" valign="middle"><a href="<?php print(base_url()."configuracion/divisas"); ?>" class="escalaGrisesConfiguracion"><span class="icon-option" title="Divisas"><img src="<?php print(base_url()); ?>img/divisas.jpg"  width="30" height="34" title="Divisas"  /></span>Divisas</a></td>
 ...
 <table class="toolbar" width="10%">
    <tr>
      <td style="border:none" width="27%" align="center" valign="middle" class="button">
        <a id="btnDivisas" onclick="formularioDivisas()" title="Agregar divisa">
        	<img src="<?php print(base_url()); ?>img/add.png" border="0" title="Añadir divisa" /> 
            <br />
            Agregar
        </a>
       ...
       <?php
		if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnDivisas\');
			</script>';
		}
       ?>
       </td>
...
if(!empty ($divisas))
{
	...
	<table width="100%" class="admintable" >
		<tr >
			...
			<th class="encabezadoPrincipal" width="15%" align="center">Clave</th>
			<th class="encabezadoPrincipal" width="15%" align="center">Tipo de cambio</th>
	...
	foreach ($divisas as $row)
	{
        ...
        <td align="center" valign="middle"><?php echo $row->clave ?></td>
        <td align="right" valign="middle">$<?php echo $row->tipoCambio ?></td>
		<td align="center" valign="middle">
        	<img id="btnEditarDivisa<?php echo $i?>" src="<?php echo base_url()?>img/editar.png" width="22" height="22" title="Editar" onClick="accesoEditarDivisa('<?php echo $row->idDivisa?>')" >
            
            &nbsp;&nbsp;
            <img id="btnBorrarDivisa<?php echo $i?>" src="<?php echo base_url()?>img/borrar.png" width="22" height="22" title="Borrar" onClick="borrarDivisa(<?php echo $row->idDivisa  ?>,'¿Realmente desea borrar esta divisa?')" >
            <br />
			<a id="a-btnEditarDivisa<?php echo $i?>">Editar</a>
            <a id="a-btnBorrarDivisa<?php echo $i?>">Borrar</a>
			...
			if($permiso[2]->activo==0)
			{
				 echo '
				<script>
					desactivarBotonSistema(\'btnEditarDivisa'.$i.'\');
				</script>';
			}
			...
			if($permiso[3]->activo==0)
			{
				 echo '
				<script>
					desactivarBotonSistema(\'btnBorrarDivisa'.$i.'\');
				</script>';
			}
		?>
		</td>
...
<div id="ventanaEditarDivisa" title="Editar divisa">
<div style="width:99%;" id="editandoDivisa"></div>
<div id="errorEditarDivisa" class="ui-state-error" ></div>
<div id="obtenerDivisa"></div>
</div>

<div id="ventanaDivisas" title="Divisas:">
<div id="registrandoDivisa"></div>
<div id="errorDivisas" class="ui-state-error" ></div>
<div id="formularioDivisas"></div>
</div>
