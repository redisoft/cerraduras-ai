<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/marcas.js"></script>
<div class="derecha">
<div class="submenu">
 ...
 <table class="toolbar" width="10%">
    <tr>
      <td style="border:none" align="center" valign="middle" class="button">
        <a id="btnAgregarMarca" onclick="formularioMarcas()" title="Agregar marca" >
       ...
       <?php
		if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnAgregarMarca\');
			</script>';
		}
       ?>
       </td>
...
<div id="procesandoMarcas"></div>
<div id="obtenerMarcas"></div>


    <div id="ventanaMarcas" title="Registrar marca">
        <div id="registrandoMarca"></div>
        <div class="ui-state-error" ></div>
        <div id="formularioMarcas"></div>
    </div>
    
    <div id="ventanaEditarMarca" title="Editar marca">
        <div id="editandoMarca"></div>
        <div class="ui-state-error" ></div>
        <div id="obtenerMarca"></div>
    </div>
