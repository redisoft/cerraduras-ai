...
<div class="listproyectos" >
    ...
    <form  name="form" id="form" action="<?php echo base_url().'configuracion/activarEstilo'?>" method="post">
        <table class="admintable" width="100%" >
            <tr class="sombreado">
                <td class="key">Color de estilo</td>
                <td title="Seleccione color">
                    <!--<div style="width:80px; height:30px; background-color:#0284c0; float:left"></div>-->
                    
                    <input name="txtColor" id="txtColor" type="text" class="cajas" style="width:100px; height:30px; color:#FFF; background-color: <?php echo $this->session->userdata('estilo')?> " onclick="startColorPicker(this)" onkeyup="maskedHex(this)" readonly="readonly" placeholder="Seleccione" value="<?php echo $this->session->userdata('estilo')?>"/>
                </td>
            </tr>
