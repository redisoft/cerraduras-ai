<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/categorias/categorias.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js/configuracion/categorias/subCategorias.js"></script>
<div class="derecha">
<div class="submenu">
    ...
    <!--<div class="seccionDiv">
     ...
     <table class="toolbar" width="100%">
        <tr>
			...
			<td width="5%" align="center" valign="middle"><a href="<?php print(base_url()."configuracion/categorias"); ?>" class="escalaGrisesConfiguracion" ><span class="icon-option" title="Categorías"><img src="<?php print(base_url()); ?>img/categorias.png"  width="30" height="34" title="Categorías"  /></span>Categorías</a></td>      
 ...
 <table class="toolbar" width="10%">
    <tr>
      <td style="border:none" align="center" valign="middle" class="button">
        <a id="btnAgregarCategoria" onclick="formularioCategorias()" title="Agregar categoría" >
            <img src="<?php print(base_url()); ?>img/add.png" /> 
            <br />
            Agregar
        </a>
       ...
       <?php
		if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnAgregarCategoria\');
			</script>';
		}
       ?>
       </td>
...
<div id="procesandoCategorias"></div>
<div id="obtenerCategorias"></div>


<div id="ventanaCategorias" title="Registrar categoría">
    <div id="registrandoCategoria"></div>
    <div class="ui-state-error" ></div>
    <div id="formularioCategorias"></div>
</div>

<div id="ventanaEditarCategoria" title="Editar categoría">
    <div id="editandoCategoria"></div>
    <div class="ui-state-error" ></div>
    <div id="obtenerCategoria"></div>
</div>

<div id="ventanaSubCategorias" title="Subcategorías">
    <div id="procesandoSubCategorias"></div>
    <div class="ui-state-error" ></div>
    <div id="obtenerSubCategorias"></div>
</div>

<div id="ventanaFormularioSubCategorias" title="Registrar subcategoría">
    <div id="registrandoSubCategoria"></div>
    <div class="ui-state-error" ></div>
    <div id="formularioSubCategorias"></div>
</div>

<div id="ventanaEditarSubCategoria" title="Editar subcategoría">
    <div id="editandoSubCategoria"></div>
    <div class="ui-state-error" ></div>
    <div id="obtenerSubCategoria"></div>
</div>
