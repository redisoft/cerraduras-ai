<script src="<?php echo base_url()?>js/configuracion/zonas/zonas.js"></script>
...
<div class="derecha" <?php echo !$mostrarMenu?'style="min-height:300px !important"':''?>>
<div class="submenu" <?php echo !$mostrarMenu?'style="height:13px !important"':''?>>
    ...
    if($mostrarMenu)
	{
		...
		<table class="toolbar" width="100%">
			...
			?>
				...
				<td width="5%" align="center" valign="middle"><a href="<?php print(base_url()."configuracion/zonas"); ?>" class="escalaGrisesConfiguracion"> <span class="icon-option" > <img src="<?php print(base_url()); ?>img/zona.png" width="30" height="30" title="<?php echo $this->session->userdata('identificador')?>" /></span> <?php echo $this->session->userdata('identificador')?> </a> </td>
...
<table class="toolbar" width="10%">
    <tr>
        <td style="border:none" width="27%" align="center" valign="middle" class="button">
        	<a id="btnRegistrarZona" onclick="formularioZonas()"  title="<?php echo $this->session->userdata('identificador')?>" style="cursor:pointer">
                <img src="<?php print(base_url()); ?>img/add.png" alttitle="Añadir <?php echo $this->session->userdata('identificador')?>" /> <br />
                Agregar
			</a>
        <?php
        if($permiso[1]->activo==0)
		{
			 echo '
			<script>
				desactivarBotonSistema(\'btnRegistrarZona\');
			</script>';
		}
        ?>
        </td>
