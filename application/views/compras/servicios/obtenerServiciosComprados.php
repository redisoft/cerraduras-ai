...
if($compras!=null)
{
	...
	<table class="admintable" style="width:100%">';
		...
		if($compra->totalRecibido==0)
		{
			...
			<tr>
				...
				<td align="center" style="border:none" colspan="2">
					<img src="'.base_url().'img/success.png" title="Recibir todos los servicios" onclick="formularioRecibirTodosMateriales('.$compra->idCompras.')" width="22" height="22"><br />
					<a>Recibir todo</a>
				</td>
			</tr>';
		}
		...
		echo'
		<tr>
			<th colspan="10">Detalles de servicios</th>
		</tr>
	...
	foreach($compras as $row)
	{
		...
		echo '<img onclick="productosRecibidos('.$row->idDetalle.')" src="'.base_url().'img/success.png" width="20" title="Recibiendo compras" id="btnRecibirProductos'.$i.'" />
		<br />
		<a>Recibidos</a>';
