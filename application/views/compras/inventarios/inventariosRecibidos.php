...
<form id="frmProductoRecibido" name="frmProductoRecibido">
	<table class="admintable" width="100%">
		...
		<tr>
			...
			<td>
				<input id="txtFechaRecibido" name="txtFechaRecibido" type="text" class="cajas" style="width:120px" readonly="readonly" value="'.date('Y-m-d H:i').'" />
				<script>
	...
	foreach($recibidos as $row)
	{
		...
		<tr '.$estilo.'>
			...
			<td align="left">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<img id="btnBorrarRecibido'.$i.'" src="'.base_url().'img/borrar.png" width="20" title="Borrar" onclick="accesoBorrarInventarioRecibido('.$row->idRecibido.')" /><br />
				<a>Comprobantes</a>
