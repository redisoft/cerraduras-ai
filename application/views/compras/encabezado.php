...
<div style="width:100%">
	<div style="width:33%; float:left">
    	<img src="<? echo base_url()?>img/logo.png" style="width:330px; height:90px;" />
    ...
    <div style="border-radius: 10px; border: solid 2px #000; width:180px; height:100px; float:right;">
   		<div align="center" style="height:25px; background-color:#000; color:#FFF; font-size:20px">ORDEN DE COMPRA</div>
...
<div style="width:100%">
	<div style="width:33%; float:left">
    	<img src="<? echo base_url()?>img/logo.png" style="width:330px; height:80px;" />
...
<table width="100%" style="border-collapse:collapse; font-size:16px; color:#000 ">
    <tr>
        <tr>
            ...
            <th width="20%" style="background-color:#000; color:#FFF; font-size:20px; border-top-left-radius:6px">P. UNITARIO</th>
            <th width="25%" align="right"  style="background-color:#000; color:#FFF; font-size:20px; border-top-left-radius:6px">IMPORTE</th>
        </tr>
    </tr>
</table>
</div>
