       ...
       if(strlen($configuracion->logotipo)>2)
        ...
        <table width="100%" class="tablaFactura">
            ...
            <tr>
                ...
                <td align="center">C.P. <?php echo $configuracion->codigoPostal?></td>
            </tr>
    ...
    <div style="margin-top:3px">
        ...
        <table width="100%" class="tablaFactura">
            ...
            <tr>
				...
				Regimen Fiscal: '.$configuracion->regimenFiscal;
        ...
        <div style="width:49%; float:right">
         <table width="100%" class="tablaFactura">
            ...
            <tr>
				...
				echo strlen($factura->calle)>0?$factura->calle:'';
				echo strlen($factura->numeroExterior)>0?' '.$factura->numeroExterior:'';
				echo strlen($factura->colonia)>0?', '.$factura->colonia:'';
				echo '<br />';
				
				echo strlen($factura->localidad)>0?$factura->localidad:'';
    ...
    <table class="tablaFactura" style="width:100%;">
        <tr>
            <th width="15%" style="color:#000">NO IDENTIFICACIÖN</th>
...
<table class="tablaFactura" style="width:100%; margin-top:3px">
    ...
    <tr>
        <td>
			...
			echo $factura->versionCfdi!='3.3'?' | IVA: $'.number_format($pago->iva,2):'';
			?>
        </td>
        <td>
...
<table class="tablaFactura" style="width:100%; margin-top:3px">
    ...
    <tr>
        ...
        <?=$factura->versionCfdi!='4.0'?'<th>Método de pago</th>':''?>
	...
	<tr>
		...
		'.($factura->versionCfdi!='4.0'?'<td>'.$relacion->metodoPago.'</td>':'').'
