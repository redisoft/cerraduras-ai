...
#if($egresos!=null)
{
	...
	<table class="admintable" width="111%">
		...
		<tr>
			...
			<th>Proveedor</th>
			<th>
				<select class="cajas" id="selectProductosBusquedaEgreso" name="selectProductosBusquedaEgreso" style="width:90px" onchange="obtenerOtrosEgresos()">
			...
			<th>Nombre</th>
			<th>
				<select class="cajas" id="selectDepartamentosBusquedaEgreso" name="selectDepartamentosBusquedaEgreso" style="width:105px" onchange="obtenerOtrosEgresos()">
			...
			<th>
				<select class="cajas" id="selectGastosBusquedaEgreso" name="selectGastosBusquedaEgreso" style="width:85px" onchange="obtenerOtrosEgresos()">
