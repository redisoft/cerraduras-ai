...
<form id="form" name="form" onsubmit="return validando()" method="post" action="<? echo base_url().'reportes/reportes_pedidos_muestra/'?>">
        <table class="admintable" width="99%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <th align="left" scope="col">
                ...
                <input type="submit" name="Submit" class="btn" value="Buscar" />                <img src="/img/print.png" alt=" " width="32" height="32" onclick="imprSelec('RESPUESTACLIENTE')"></th>
          </tr>
      </table>
    </form>
...
<table class="admintable" width="98%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <th scope="col">&nbsp;</th>
    <th scope="col">&nbsp;</th>
  </tr>
