<script src="<?php echo base_url()?>js/reportes/prefacturas.js?v=<?php echo(rand());?>"></script>
	...
	<table class="toolbar" width="100%">
        <tr>
            <td>
					...
					<input type="text"  name="txtCriterioBusqueda" id="txtCriterioBusqueda" class="busquedas"  style="width:500px;" placeholder="Buscar por cliente, remisión, prefactura"/>
