...
<table class="admintable" width="100%">
	<tr>
		<th colspan="6" style="border-right:none" class="encabezadoPrincipal" align="right">
			Reporte de egresos
		</th>
...
if($gastos!=null)
{
	...
	foreach($gastos as $row)
	{
		...
		<tr '.$estilo.'>
			...
			echo'</td>
			<td>'.$row->producto.'
			<img src="'.base_url().'img/egresos.png" width="22" height="22" title="Detalles de gastos" onclick="obtenerGastoInformacion('.$row->idEgreso.')"  />
			</td>
			<td align="center">';
			...
			<td align="center">'.$row->remision.'</td>
