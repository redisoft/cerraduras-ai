...
<table class="admintable" width="100%">
	<tr>
		<th colspan="15" class="encabezadoPrincipal" align="right">Total $ '.number_format($total,2).'</th>
	</tr>
	<tr>
		<th width="3%">#</th>
		<th width="6%">Fecha</th>
		...
		<th width="6%">Venta</th>
		<th width="6%">Estación</th>
		<th width="8%">'.$this->session->userdata('identificador').'</th>
		<th width="8%">Agente de ventas</th>
		<th width="4%">CRM</th>
