	...
	<table class="admintable" width="100%">
		<tr>
			...
			<th class="encabezadoPrincipal" style="border-right:none; border-left:none">
				<img id="btnExportarPdfReporte" onclick="window.open(\''.base_url().'reportes/reportePronosticoIngresos/'.$inicio.'/'.$fin.'/'.$idCliente.'\')" src="'.base_url().'img/pdf.png" width="22" title="Pdf" />
				&nbsp;
				<img id="btnExportarExcelReporte" onclick="excelPronosticoIngresos(\''.$inicio.'\',\''.$fin.'\','.$idCliente.')" src="'.base_url().'img/excel.png" width="22" title="Excel" />
				<br />
				<a>PDF</a>
				<a>Excel</a>';
